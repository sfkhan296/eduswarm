...
const taglines = [
  ...
  "AI agents that adapt to you.",
  "Personalized paths to mastery.",
  "Your swarm of AI tutors, always ready.",
  "Every learner is unique — so is your curriculum.",
];
...
export default function SignInPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-violet-50 to-indigo-100 dark:from-gray-950 dark:to-gray-900">
      {/* Decorative blobs */}
      <motion.div
        className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-violet-300/30 blur-3xl dark:bg-violet-700/20"
        initial={{ opacity: 0, scale: 0.6 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 1.2, ease: "easeOut" }}
      />
      <motion.div
        className="pointer-events-none absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-indigo-300/30 blur-3xl dark:bg-indigo-700/20"
        initial={{ opacity: 0, scale: 0.6 }}
        animate={{ opacity: 1, scale: 1 }}
