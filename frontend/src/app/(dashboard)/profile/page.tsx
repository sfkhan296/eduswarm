      ...
      <motion.div variants={container} initial="hidden" animate="show" className="space-y-4">
        ...
        <motion.div variants={item} className="rounded-xl border bg-card p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 mb-5">
            ...
            <StatCard icon={Target}   label="Quiz Accuracy" value={gamification && gamification.totalAnswered > 0 ? `${Math.round((gamification.totalCorrect / gamification.totalAnswered) * 100)}%` : "—"} color="bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400" />
          </div>
